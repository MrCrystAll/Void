...
from stable_baselines3.common.policies import ActorCriticPolicy, BasePolicy, ActorCriticCnnPolicy, \
...
class DynamicOnPolicyAlgorithm(BaseAlgorithm):
    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            for i in range(old_ep_starts.shape[0]):
                self._last_episode_starts += [old_ep_starts[i]]

            self._last_episode_starts = np.array(self._last_episode_starts)
...
class MyPPO(DynamicOnPolicyAlgorithm):
    """
