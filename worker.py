...
from rlgym_sim.utils.reward_functions.common_rewards import VelocityBallToGoalReward, EventReward, TouchBallReward, \
    FaceBallReward
...
from Rewards import TraceableSB3CombinedLogReward
...
class Worker:
    def __init__(self, reward_update):
    ...
    def run(self):
        ...
        match = Match(
            ...
            terminal_conditions=[TimeoutCondition(round(2000)),
                                 GoalScoredCondition()],
            reward_function=TraceableSB3CombinedLogReward(
                reward_functions=(
